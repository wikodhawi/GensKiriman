...
@RestController
@RequestMapping("/GensWilayah")
public class GensWilayahCtl {
	
	@Autowired
	GensWilayahSvc gensWilayahSvc;

	@RequestMapping(value = "/getall", method = RequestMethod.GET)
	public RestResponse loadList() {

		Map<String, Object> map = gensWilayahSvc.findAll();
	...
	public RestResponse loadListLov(
		...
		Map<String, Object> map = gensWilayahSvc.loadList(mapInput, search, pageSequence, size, direction, orderBy);
		return new RestResponse(CommonConstants.OK_REST_STATUS, null,
