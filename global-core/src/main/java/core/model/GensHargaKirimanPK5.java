 ...
 */
@Embeddable
public class GensHargaKirimanPK5 implements Serializable {
	// default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private String companyCode;
	private String kodeKiriman;

	public GensHargaKirimanPK5() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof GensHargaKirimanPK5)) {
			return false;
		}
		GensHargaKirimanPK5 castOther = (GensHargaKirimanPK5) other;
