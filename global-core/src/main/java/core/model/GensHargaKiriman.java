...
@IdClass(GensHargaKirimanPK.class)
@NamedQuery(name = "GensHargaKiriman.findAll", query = "SELECT g FROM GensHargaKiriman g")
public class GensHargaKiriman implements Serializable {
